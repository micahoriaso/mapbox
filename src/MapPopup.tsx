...
const MapPopup = ({
  ...
  <Popup
    ...
    onClose={(): void => setSelectedLocation(null)}
    className="map-popup"
  >
    <div>
      <div className="location-title">
        {selectedLocation.properties.Facility_Service_Name}
      </div>
      <PopupListItem
      ...
      <PopupListItem
        ...
        propertyValue={
          selectedLocation.properties.Facility_Service_shared_by_people
        }
      />
      <PopupListItem
        ...
        propertyValue={
          selectedLocation.properties
            .Facility_Service_not_shared_by_people_reason
        }
      />
      <PopupListItem
        propertyKey={"People served at facility per day:"}
        propertyValue={
          selectedLocation.properties.People_served_at_Facility_Per_Day
        }
      />
      <PopupListItem
        propertyKey={"Challenge present with sharing resource:"}
        propertyValue={
          selectedLocation.properties.Challenges_facility_sharing_present
        }
      />
      <PopupListItem
