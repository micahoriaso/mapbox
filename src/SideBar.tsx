  ...
  <div className="sidebar">
    <Segment vertical textAlign="left">
      ...
      <Form>
        ...
        <Header as="h4">Round of Mapping</Header>
        ...
        <Header as="h4">Operational Challenges</Header>
        ...
        <Header as="h4">Facilities shared across countries</Header>
        ...
        <Form.Field>
          <Checkbox
            ...
            checked={
              mapStyle ===
              "mapbox://styles/micahoriaso/ck1anddqi02vj1cpg8is5rbty"
            }
